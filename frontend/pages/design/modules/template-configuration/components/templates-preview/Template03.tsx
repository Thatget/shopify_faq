  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: `url(https://backend-faq.yanet.io/var/images/banner/banner-default-3.png)`,
        ...
        <div className="flex">
          <div className="w-4/12">
            <div className="flex flex-col me-8 mt-9">
              <div className="px-2 py-3 border-t" style={{ borderColor: '#cccccc'}}>
                Placing an order
              </div>
              <div className="px-2 py-3 border-t border-b" style={{ borderColor: '#cccccc'}}>
                Refunds
              </div>
            </div>
          </div>
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between p-3 rounded cursor-pointer border-t" style={{ borderColor: '#cccccc'}}>
            ...
            <div className="flex flex-col p-3 border-t border-b" style={{ borderColor: '#cccccc'}}>
              <div className="flex items-center justify-between rounded cursor-pointer mb-3">
                <p>How do I redeem my One 4 All card?</p>
                <svg fill="#696969" viewBox="0 0 448 512" style={{ width: '14px', height: '14px' }}><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"></path></svg>
              </div>
              <div>
                <p>
